...
Media library - [http://github.com/webver/vdk](https://github.com/webver/vdk). License is [MIT](https://github.com/webver/vdk/blob/master/LICENSE). We are using fork actually - https://github.com/LdDl/vdk
